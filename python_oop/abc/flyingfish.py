...
class Fish:
    ...
    def swim(self):
        """Print swimming message for fish."""
        print("The fish is swimming")

    def habitat(self):
        """Print habitat message for fish."""
        print("The fish lives in water")


class Bird:
    """Bird class representing avian behavior."""

    def fly(self):
        """Print flying message for bird."""
        print("The bird is flying")

    def habitat(self):
        """Print habitat message for bird."""
